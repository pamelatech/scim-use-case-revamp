...
#### 2.2.3.  Triggers
   ...
   An example of this could be the RC (Resource Creator) pull the RO (Resource Object) from the RM (Resource Manager).
   ...
   An example of this could be the RC (Resource Creator) or RU (Resource Updater) pulls the update of RO (Resource Object) or its RA (Resource Attributes) from the RM (Resource Manager).
   ...
   An Example of this could be the RC (Resource Creator) or RU (Resource Updater) pulls the delete operation from the RM (Resource Manager).
